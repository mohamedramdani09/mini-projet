    ...
    <>
      ...
      <div className={`review-content ${reviewShow ? "review-content-show" : "description-show"}`}>
                ...
                <div className='review-form'>
                    ...
                    <form action="action" className='row'>
                        ...
                        <div className='col-md-12 col-12'>
                            <textarea name="message" id="message" rows="8" placeholder='Type here message...'  value={text} onChange={handleChange} >  </textarea>
                        </div>
        ...
        <div className='description'>
            <p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam eveniet vero consequatur ratione ad mollitia, maiores inventore quos delectus dolor tempore deserunt quae. Dolore a suscipit consectetur quam neque impedit!
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam eveniet vero consequatur ratione ad mollitia, maiores inventore quos delectus dolor tempore deserunt quae. Dolore a suscipit consectetur quam neque impedit! </p>
            ...
            <div className='post-item'>
                ...
                <div className='post-content'>
                    <ul className='lab-ul'>
                        <li> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et, fugit. </li>
                        <li> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et, fugit. </li>
                        <li> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et, fugit. </li>
                        <li> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et, fugit. </li>
                        <li> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et, fugit. </li>
